...
if COMPILER == "gcc" or COMPILER == "clang" then
    CPRE = COMPILER..[[ -E -DIMGUI_DISABLE_OBSOLETE_FUNCTIONS -DIMGUI_API="" -DIMGUI_IMPL_API="" -DIMGUINODES_NAMESPACE="imguinodes"]]
...
if INTERNAL_GENERATION then
	cimgui_header = cimgui_header..[[//with internal.h api
]]
end
--------------------------------------------------------------------------
--helper functions
...
--get nodes.h version--------------------------
--[=[
local pipe,err = io.open("../nodes/nodes.h","r")
if not pipe then
...
local function parseImGuiHeader(header,names)
    ...
    parser.UDTs = {"ImVec2","ImVec4","ImColor","ImRect","ImGuiNodesInput","ImGuiNodesOutput","ImGuiNodesConnectionDesc"}
	...
	parser.ftemplate_list.T = {"float", "double", "ImS8", "ImU8", "ImS16", "ImU16", "ImS32", "ImU32", "ImS64", "ImU64","ImGuiNodesInput","ImGuiNodesOutput","ImGuiNodesConnectionDesc"}
...
local modulename = "cimgui_nodes"

local headers = [[#include "../nodes/nodes.h" 
]]
local headersT = {[[nodes]]}
-- if INTERNAL_GENERATION then
--     headers = headers .. [[#include "../nodes/nodes.h"
-- 	]]
-- 	headersT[#headersT + 1] = [[nodes]]
-- end
...
--local parser1 = parseImGuiHeader([[../nodes/nodes.h]],{[[nodes]]})
--parser1:do_parse()
